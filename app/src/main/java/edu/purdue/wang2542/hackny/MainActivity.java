...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        view = new TicTacToeView(myButtons, newGame, getApplicationContext(), colour, PvE); //Initializes the TicTacToeView object
        myObj = new TicTacToe(view, PvE, getApplicationContext()); //Initializes the TicTacToe object
    }
